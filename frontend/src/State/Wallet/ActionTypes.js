...
export const DEPOSIT_MONEY_REQUEST = "GET_DEPOSITE_MONEY_REQUEST";
export const DEPOSIT_MONEY_SUCCESS = "GET_DEPOSITE_MONEY_SUCCESS";
export const DEPOSIT_MONEY_FAILURE = "GET_DEPOSITE_MONEY_FAILURE";
